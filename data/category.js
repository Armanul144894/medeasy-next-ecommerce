  const allCategories = [
    ...
    { id: 4, name: "First Aid", icon: "⚕️", count: 6 },
    ...
    { id: 14, name: "Respiratory Care", icon: "🫁", count: 4 },
    { id: 15, name: "Sexual Wellness", icon: "💗", count: 3 },
    ...
    { id: 20, name: "Fitness & Nutrition", icon: "🥗", count: 5 },
];
