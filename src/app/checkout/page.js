...
import { CreditCard, Truck, Package, Shield, ChevronRight, Home, Lock, Tag, Check } from 'lucide-react';
        ...
        <div className="min-h-screen">
            ...
            <div className=" px-4 py-8">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600 mb-8">
                    ...
                    <button className="hover:text-teal-600">Cart</button>
                    <ChevronRight size={16} />
                    ...
                    <div className="mb-8 pt-8">
                        <div className="flex items-center justify-center">
                            <div className="flex items-center">
                                {/* Step 1 */}
                                <div className="flex items-center">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= 1 ? 'bg-teal-600 text-white' : 'bg-gray-200 text-gray-500'
                                        }`}>
                                        {currentStep > 1 ? <Check size={20} /> : '1'}
                                    </div>
                                    <span className={`ml-2 font-semibold ${currentStep >= 1 ? 'text-teal-600' : 'text-gray-500'}`}>
                                        Shipping
                                    </span>
                                </div>

                                <div className={`w-16 h-1 mx-2 ${currentStep >= 2 ? 'bg-teal-600' : 'bg-gray-200'}`}></div>

                                {/* Step 2 */}
                                <div className="flex items-center">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= 2 ? 'bg-teal-600 text-white' : 'bg-gray-200 text-gray-500'
                                        }`}>
                                        {currentStep > 2 ? <Check size={20} /> : '2'}
                                    </div>
                                    <span className={`ml-2 font-semibold ${currentStep >= 2 ? 'text-teal-600' : 'text-gray-500'}`}>
                                        Payment
                                    </span>
                                </div>

                                <div className={`w-16 h-1 mx-2 ${currentStep >= 3 ? 'bg-teal-600' : 'bg-gray-200'}`}></div>

                                {/* Step 3 */}
                                <div className="flex items-center">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= 3 ? 'bg-teal-600 text-white' : 'bg-gray-200 text-gray-500'
                                        }`}>
                                        {currentStep > 3 ? <Check size={20} /> : '3'}
                                    </div>
                                    <span className={`ml-2 font-semibold ${currentStep >= 3 ? 'text-teal-600' : 'text-gray-500'}`}>
                                        Review
                                    </span>
                                </div>
                            </div>
                    ...
                    {currentStep === 1 && (
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <form onSubmit={handleShippingSubmit}>
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-teal-600 text-white py-4 rounded-lg font-semibold hover:bg-teal-700 transition flex items-center justify-center gap-2"
                                >
                                    Continue to Payment
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="grid md:grid-cols-3 gap-4 mb-6">
                                <button
                                    ...
                                    className={`p-4 border-2 rounded-lg transition ${paymentMethod === 'card' ? 'border-teal-600 bg-teal-50' : 'border-gray-300'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-4 border-2 rounded-lg transition ${paymentMethod === 'paypal' ? 'border-teal-600 bg-teal-50' : 'border-gray-300'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-4 border-2 rounded-lg transition ${paymentMethod === 'cod' ? 'border-teal-600 bg-teal-50' : 'border-gray-300'
                                        }`}
                                >
                                    <Package className="mx-auto mb-2 text-teal-600" size={32} />
                            ...
                            {paymentMethod === 'card' && (
                                <form onSubmit={handlePaymentSubmit}>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <button
                                            type="submit"
                                            className="flex-1 bg-teal-600 text-white py-4 rounded-lg font-semibold hover:bg-teal-700 transition flex items-center justify-center gap-2"
                                        >
                                            Review Order
                                            <ChevronRight size={20} />
                                        </button>
                            ...
                            {paymentMethod === 'paypal' && (
                                <div>
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6 text-center">
                                        ...
                                        <div className="w-32 h-12 bg-blue-600 rounded mx-auto mb-2"></div>
                                    </div>
                                    <div className="flex gap-4">
                                        <button
                                            onClick={() => setCurrentStep(1)}
                                        ...
                                        <button
                                            ...
                                            className="flex-1 bg-teal-600 text-white py-4 rounded-lg font-semibold hover:bg-teal-700 transition"
                                        >
