  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <button
        ...
        className="bg-teal-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-teal-700 transition"
      >
        Open Sign In Modal
      </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden animate-fadeIn">
            <div className="flex flex-col md:flex-row">
              {/* Left Side - Branding */}
              <div className="bg-gradient-to-br from-teal-500 to-cyan-600 p-8 md:w-2/5 text-white relative overflow-hidden">
                {/* Close Button - Mobile */}
                <button
                ...
                <div className="mb-8">
                  ...
                  <p className="text-teal-100 text-lg">দেশের সেবায় ডিজিটাল লেয়ার স্বাস্থ্য</p>
                  <p className="text-white/90 mt-2">
                    এখন আপনার সকল সব মানের<br />ডিজিটাল হেলথ ফার্মেসি
                  </p>
                </div>
              ...
              <div className="p-8 md:w-3/5 relative">
                ...
                <button
                  onClick={() => setIsOpen(false)}
                  className="hidden md:block absolute top-4 right-4 p-2 hover:bg-gray-100 rounded-full transition"
                >
                ...
                <div className="max-w-md mx-auto">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                      {isSignUp ? 'Sign up to get started' : 'Welcome back! Please enter your details'}
                    </p>
                  </div>
                  ...
                  <div className="mb-6">
                    <p className="text-xs text-gray-600">
                      ...
                      {' '} & <a href="#" className="text-teal-600 hover:underline">Refund-Return Policy</a>
                    </p>
                  </div>
                  ...
                  >
                    {loginMethod === 'phone' ? 'Send OTP' : isSignUp ? 'Sign Up' : 'Sign In'}
                  </button>
